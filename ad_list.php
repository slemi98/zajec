<?php
    ...
    while ($row = mysql_fetch_array($result)) {
        ...
        if (mysql_num_rows($r) > 0) {
            ...
            echo '<img class="ad_picture" src="'.$slika['url'].'" width="100px" />';
        }
        else {
            //nima slike
            echo '<img class="ad_picture" src="images/nopicture.jpg" width="100px" />';
        }
        echo '</a>';
        echo "<h3>".$row['title']."</h3>";       
        echo "<b>"."Cena: ".$row['price']." € </b>";
        echo '<br />';
        echo "<i>"."Kategorija: ".$row['name']."</i>";
        echo '</div>';
    }
